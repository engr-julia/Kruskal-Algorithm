...
public class KruskalModernGUI extends JFrame {
    ...
    private Graph graph;
    private BSCS2_Rodrigo_KruskalAlgorithm kruskal;
    private List<BSCS2_Rodrigo_KruskalAlgorithm.EdgeStatus> edgeStatuses;
    ...
    private void computeMST() {
        kruskal = new BSCS2_Rodrigo_KruskalAlgorithm(graph);
    ...
    private void updateStep() {
        ...
        for (int i = 0; i < currentStep; i++) {
            BSCS2_Rodrigo_KruskalAlgorithm.EdgeStatus edgeStatus = edgeStatuses.get(i);
